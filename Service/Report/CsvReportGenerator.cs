namespace solidInCsharp.Service.Report
{
    public class CsvReportGenerator: IReportGenerator
    {
		...
		public void IniciarRelatorio() => relatorio = "";

		public void IniciarHeaders()
        { }

		public void AdicionarHeader(string valor) => relatorio += valor + ";";
		...
		public void AdicionarColuna(string valor) => relatorio += valor + ";";
		...
		public string FinalizarRelatorio() => relatorio;
    }
}
